...
/CounTR/FSC_finetune_cross.py --epochs 500 --batch_size 8 --lr 1e-6 --output_dir ./data/train/CounTR-exp --title CounTR-exp --resume ./FSC147.pth --data_path /tmp/datasets --
wandb CounTR